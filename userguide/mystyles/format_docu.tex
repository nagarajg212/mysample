...
\ifthenelse{\equal{\lang}{german}}{%
    %\documentclass[index=totoc,ngerman,12pt,\docupagemode,a4paper,headings=normal,headsepline,numbers=noenddot,footsepline,\graphmode]{scrbook}
    ...
    \ifthenelse{\equal{\lang}{french}}{%
        \documentclass[idxtotoc,french,12pt,\docupagemode,a4paper,normalheadings,headsepline,pointlessnumbers,footsepline,\graphmode]{scrbook}
    }{
    % english by default
        %\documentclass[index=totoc,english,12pt,\docupagemode,a4paper,headings=normal,headsepline,numbers=noenddot,footsepline,\graphmode]{scrbook}
